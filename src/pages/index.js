      ...
      <div className="inner">
        <header className="major">
          ...
          <p>
            ...
            en el día a día y en el trabajo en equipo, interés por la criptografía y la seguridad Informática.
            <br />
        ...
        <ul className="icons major">
          <li>
            <span className="icon solid fa-coffee major style1">
              <span className="label">Lorem</span>
            </span>
          </li>
          <li>
            <span className="icon solid fa-shield-alt major style2">
